...
export default function Menu() {
  ...
  const dropdownLinks = [
    ...
    { href: '/orders', label: 'Orders', icon: <BoxIcon /> }, // <-- UPDATED LINK
    ...
    <div className="flex items-center space-x-4">
      <div className="relative">
        <button
          ...
          className="flex items-center space-x-2 p-2 rounded-md bg-amber-400 text-black font-semibold hover:bg-amber-500"
        >
          <UserIcon />
...
const BoxIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-14L4 7v10l8 4m0-14l8-4-8 4" />
  </svg>
)
const HeartIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
